...
public class hotel_reservation_system {
	...
	private static final String password = "004321";
	...
	private static void updateReservation(Connection connection, Scanner sc) {
		try {
			...
			int reservationId = sc.nextInt();
			sc.nextLine(); // consume the newlinw character

			if (!reservationExists(connection, reservationId)) {
				System.out.println("Reservation not find for the given ID");
				return;
			}
	...
	private static void deleteReservation(Connection connection, Scanner sc) {
		try {
			...
			if (!reservationExists(connection, reservationId)) {
				System.out.println("Reservationn not found for the given ID");
				return;
			}
